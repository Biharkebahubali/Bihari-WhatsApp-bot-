// ✅ BIHARI Bot Stylish Configuration – by BIHAR_KE_BAHUBALI ❦ ✓

const ownerNumber = require('./Owner/owner'); // 🔗 Example: ['918825297632']

const config = {
  // 👑 Owner Info
  ownerNumber,                          // 🔹 Array of Owner Numbers
  ownerName: '𓆩 BIHAR_KE_BAHUBALI ❦︎𓆪',              // 🔹 Displayed in Greetings
  botName: '🤖 BIHARI 𝑩𝑶𝑻 ⚡',           // 🔹 Bot Display Name
  signature: '> BIHAR_KE_BAHUBALI ❦ ✓',               // 🔹 Footer on Bot Replies
  youtube: 'https://youtube.com/@bihar_ke_bahubali?si=lpCVUWL3-nfTkkse', // 🔹 Optional YouTube
